...
interface StudentDashboardProps {
  ...
  onNavigate: (view: 'home' | 'dashboard' | 'battle' | 'emotional' | 'profile' | 'ranking' | 'chat' | 'shop') => void;
  onLogout: () => void;
}
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="bg-[#ffcc33] hover:bg-[#ff9933] px-4 py-2 border-4 border-[#d4a02c] flex items-center gap-2 pixel-button transition-all"
              >
