...
import { X, Send, Paperclip, BookOpen, Heart, Sparkles, Upload, FileText, Image as ImageIcon, Loader2 } from 'lucide-react';
import { SensoryModeToggle } from './SensoryModeToggle';
import { Message, ToneType, FileAttachment } from '../types/assistant';
import { processFile, validateFile, formatFileSize } from '../services/fileProcessor';
